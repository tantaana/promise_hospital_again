            ...
            <div className='bg-blue-700 text-slate-200	 '>
                <div className='w-11/12 mx-auto md:p-10'>
                    <div className='text-center '>
                        ...
                        <p className='leading-loose'>Manipal Hospitals is a multi-specialty hospital in India that has transformed patient care and experiences beyond boundaries by providing innovative treatment, cutting-edge infrastructure, and an unwavering dedication to clinical excellence. We deliver best-in-class comprehensive super-speciality healthcare for patients arriving from all over the world. Our wide array of international patient services makes it simpler for you to get expert care. Our experts will provide you with the best treatment and quality care possible, making your stay more comfortable during your treatment. Manipal Hospitals is a leading multi-speciality healthcare facility in India, serving both national and international patients. With a network of 28+ hospitals and more than 7600 operational beds, our commitment to the overall well-being of an individual is at the core of everything we do. We deliver quality healthcare services to everyone through our network of hospitals and knowledgeable team of medical professionals.</p>
                    </div>

                    <div className='text-center mt-12'>
                        <h1 className='text-3xl font-semibold mb-3'>Our Core Values</h1>
                        <p className='leading-loose'>At Manipal Hospitals, we are committed to clinical quality, patient-centricity, and ethical standards. The high caliber of our team of medical practitioners demonstrates our dedication to clinical excellence. We have a team of experienced nursing staff and paramedical specialists who provide great support to our clinical team. Our medical services are customized to our patient's requirements. We offer a compassionate and supportive environment for patients and their caregivers. We attach the highest importance to ethical practices which is evident in our professional conduct, honesty, trust, and confidentiality. At Manipal Hospitals, we are committed to clinical excellence, patient-centricity, and ethical practices. The high calibre of our team of medical practitioners demonstrates our dedication to clinical excellence. We have a team of experienced nursing staff and paramedical specialists who provide great support to our clinical team. Our medical services are customized to our patient's requirements. We offer a compassionate and supportive environment for patients and their caregivers. We attach the highest importance to ethical practices which is evident in our professional conduct, honesty, trust, and confidentiality. Manipal Hospital provides unparalleled clinical excellence and a positive patient experience to its national and international patients. Manipal Hospitals Global is one of the top multi-specialty hospitals in India, well-equipped with advanced medical appliances and the latest technology available for different procedures and treatments. We strive to create a unique environment with outstanding facilities, courteous staff, and cutting-edge medical procedures.</p>
                    </div>
                </div>
            </div>
            <OurLeader></OurLeader>
