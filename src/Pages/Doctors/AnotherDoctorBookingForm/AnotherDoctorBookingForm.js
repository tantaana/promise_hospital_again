...
import '../DoctorBookingForm/doctorBookingForm.css'
...
import bgImg from '../DoctorBookingForm/BookingImage/doc-new.png'
        ...
        <div className="cardbg-white mx-8">
            ...
            <form onSubmit={handlePatient} className="modal">
                <div className="modal-box relative w-11/12 max-w-6xl rounded-sm border border-blue-900">
                    <label htmlFor="anotherdoctor-book-modal" className="btn btn-sm btn-circle border-none absolute right-2 top-2 hover:bg-gray-400 text-black hover:text-white">✕</label>
