                                ...
                                <div className=" grid xl:grid-cols-2 lg:grid-cols-1 border-4 bg-white py-20 px-8 rounded-2xl">
                                    <div className="left ">
                                        ...
                                        <div className="item flex mt-8">
                                            ...
                                            <div className="ml-4">
                                                <h2 className="primary-color font-bold text-xl flex items-center gap-2"><BiBookReader /> Qualification</h2>
                                                <p className="text-gray-500 text-sm h-20 overflow-y-auto ">{qualification}</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="right mt-8">
                                        <label htmlFor="doctor-opinion-modal" className="btn px-8 py-4 rounded font-bold">Get a second opinion</label>
                                        <label htmlFor='doctor-booking-modal-profile' className="btn px-8 py-4 rounded font-bold">Video consultation</label>
                                    </div>
                                </div>
                            </div>
                        </div>
