            ...
            <div className=''>
                <div className="rounded-lg p-0.5 pr-3 xl:pr-3 bg-gradient-to-b from-blue-900 to-teal-500 scale-100 hover:scale-105 ease-in duration-200">
                    <div className="bg-white rounded-lg xl:flex items-center justify-center gap-6">
                        <figure className='flex justify-center'><img src={doctorImg} alt="" className='rounded-lg w-full xl:w-[350px] h-[300px] object-cover mb-10 xl:mb-0 xl:border xl:border-blue-900 xl:border-r-4 xl:border-l-0 xl:border-y-0' /></figure>
                        <div className="flex flex-col justify-between xl:h-[300px] xl:w-[600px] px-4">
                            <div className='flex gap-2 mb-12 mt-4'>
                                <h2 className="text-blue-800 font-semibold text-2xl">{name}</h2>

                                <h2>{loader ? <img src={circleImg} className='w-[40px] h-[40px]' alt="" /> : ''}</h2>
