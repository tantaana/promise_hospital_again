            ...
            <div className='py-8 px-2   sm:px-64 md:px-64  ' >
                <div className=' '>
                    ...
                    <div className='text-base'>
                        <p cl>Thousands of International patients visit Promise Hospitals in India for medical treatment every year.
                        ...
                        <p className='text-base'>
                            Promise Hospitals is at the forefront of medical tourism in India.
